...
class Translation(db.Model):
    ...
    uzb_content: Mapped[str] = mapped_column(String)
    eng_content: Mapped[str] = mapped_column(String)
    uzb_content_length: Mapped[int] = mapped_column(Integer)
    eng_content_length: Mapped[int] = mapped_column(Integer)
    date: Mapped[str] = mapped_column(String)
    input_time: Mapped[str] = mapped_column(String)
    output_time: Mapped[str] = mapped_column(String)
    duration: Mapped[str] = mapped_column(Float)
    ip_address: Mapped[str] = mapped_column(String)
    browser_family: Mapped[str] = mapped_column(String)
    browser_version: Mapped[str] = mapped_column(String)
    device_family: Mapped[str] = mapped_column(String)
