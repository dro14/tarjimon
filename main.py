...
class Translation(db.Model):
    ...
    uzb_content: Mapped[str] = mapped_column(String, nullable=True)
    eng_content: Mapped[str] = mapped_column(String, nullable=True)
    uzb_content_length: Mapped[int] = mapped_column(Integer, nullable=True)
    eng_content_length: Mapped[int] = mapped_column(Integer, nullable=True)
    date: Mapped[str] = mapped_column(String, nullable=True)
    input_time: Mapped[str] = mapped_column(String, nullable=True)
    output_time: Mapped[str] = mapped_column(String, nullable=True)
    duration: Mapped[str] = mapped_column(Float, nullable=True)
    ip_address: Mapped[str] = mapped_column(String, nullable=True)
    browser_family: Mapped[str] = mapped_column(String, nullable=True)
    browser_version: Mapped[str] = mapped_column(String, nullable=True)
    device_family: Mapped[str] = mapped_column(String, nullable=True)
    device_brand: Mapped[str] = mapped_column(String, nullable=True)
    device_model: Mapped[str] = mapped_column(String, nullable=True)
    os_family: Mapped[str] = mapped_column(String, nullable=True)
